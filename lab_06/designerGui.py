...
"padding: 4px;")
        ...
        self.superPixelButton = QtWidgets.QPushButton(self.groupBox_3)
        self.superPixelButton.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(113, 0, 0);\n"
"font: bold 16px;")
        self.superPixelButton.setObjectName("superPixelButton")
        self.gridLayout_2.addWidget(self.superPixelButton, 7, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.delayCHB, 10, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.frame_3, 8, 0, 1, 1)
...
"padding: 4px;")
        ...
        self.frame_5.setStyleSheet("QSpinBox{\n"
...
"}")
        ...
        self.superPixelXEdit = QtWidgets.QSpinBox(self.frame_5)
        self.superPixelXEdit.setMinimum(-1000)
        self.superPixelXEdit.setMaximum(1000)
        self.superPixelXEdit.setObjectName("superPixelXEdit")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.superPixelXEdit)
        self.superPixelYEdit = QtWidgets.QSpinBox(self.frame_5)
        self.superPixelYEdit.setMinimum(-1000)
        self.superPixelYEdit.setMaximum(1000)
        self.superPixelYEdit.setObjectName("superPixelYEdit")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.superPixelYEdit)
        ...
        self.gridLayout_2.addWidget(self.frame_5, 6, 0, 1, 1)
...
"font: bold 16px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.superPixelButton.setText(_translate("MainWindow", "Затравочный пиксел"))
        self.delayCHB.setText(_translate("MainWindow", "Выполнить задержку"))
        self.checkBox.setText(_translate("MainWindow", "Отрисовка прямыми"))
